...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 31 mars 2025 à 21:41
...
CREATE TABLE IF NOT EXISTS `cv` (
  `ID-CV` int NOT NULL AUTO_INCREMENT COMMENT 'Identifiant du cv d''un étudiant',
  `ID-etudiant-CV` int NOT NULL COMMENT 'identifiant de l''etudiant a qui appartient le cv (clé étrangère table Etudiant)',
...
CREATE TABLE IF NOT EXISTS `etudiant` (
  ...
  `Chemin-CV` varchar(255) NOT NULL COMMENT 'Chemin d''acces vers le cv',
  `ID-promotion-etudiant` int NOT NULL COMMENT 'identifiant de la promotion (clé étrangère table Promotion)',
...
INSERT INTO `offrestage` (`ID-offre`, `Nom-offre`, `Description-offre`, `Competences-offre`, `Debut-offre`, `Fin-offre`, `Secteur-offre`, `Localisation-offre`, `ID-entreprise`) VALUES
